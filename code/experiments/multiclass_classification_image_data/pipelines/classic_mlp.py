...
def run_classic_mlp(X_train_pca, X_test_pca, y_train, y_test):
    ...
    mlp = MLPClassifier(hidden_layer_sizes=(10, 10), activation="tanh", solver="sgd", alpha=0.00013042052394947776,
                        learning_rate_init=0.0014724389615088562, learning_rate="invscaling", batch_size=128,
                        max_iter=1, early_stopping=False, tol=2.975703376542151e-05, shuffle=True, warm_start=True)
...
#             'batch_size': trial.suggest_categorical('batch_size', [1, 32, 64, 128, 256]),
#             'tol': trial.suggest_float('tol', 1e-6, 1e-3, log=True),
#             'shuffle': trial.suggest_categorical('shuffle', [True, False])
#         }
#
#         mlp = MLPClassifier(**params, early_stopping=True, max_iter=1000)
#
#         # Fit the model
